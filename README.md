...
Built as part of a 1-month online embedded systems internship at Emertxe Information Technologies.
...
Clone this repo
Open STM32CubeIDE → File → Import → Existing Projects into Workspace → select the cloned folder
Build the project (Project → Build All)
Open the generated .elf/.bin in PICSimLab, configure it as an STM32F103C8T6 (Blue Pill) board
Run the simulation
